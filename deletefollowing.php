...
try {
  ...
  $sql = "DELETE FROM `follower_table` WHERE `Followed_User_ID` = ? AND `Following_User_ID` = ?";
  ...
  $sql = null;
  $conn = null;
  header("refresh:0.1;url=followingspage.php");
} catch(PDOException $e) {
  echo "Connection failed: " . $e->getMessage();
  echo "<br>Try again!";
  echo "<br>Redirecting in three seconds...";
  header("refresh:3;url=followingspage.php");
}
?>